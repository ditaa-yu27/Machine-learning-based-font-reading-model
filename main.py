...
HurufA = len([f for f in os.listdir("HurufA") if f.endswith('.png')])
HurufB = len([f for f in os.listdir("HurufB") if f.endswith('.png')])
HurufC = len([f for f in os.listdir("HurufC") if f.endswith('.png')])
HurufD = len([f for f in os.listdir("HurufD") if f.endswith('.png')])
HurufE = len([f for f in os.listdir("HurufE") if f.endswith('.png')])
HurufF = len([f for f in os.listdir("HurufF") if f.endswith('.png')])
HurufG = len([f for f in os.listdir("HurufG") if f.endswith('.png')])
HurufH = len([f for f in os.listdir("HurufH") if f.endswith('.png')])
HurufI = len([f for f in os.listdir("HurufI") if f.endswith('.png')])
HurufJ = len([f for f in os.listdir("HurufJ") if f.endswith('.png')])
HurufK = len([f for f in os.listdir("HurufK") if f.endswith('.png')])
HurufL = len([f for f in os.listdir("HurufL") if f.endswith('.png')])
HurufM = len([f for f in os.listdir("HurufM") if f.endswith('.png')])
HurufN = len([f for f in os.listdir("HurufN") if f.endswith('.png')])
HurufO = len([f for f in os.listdir("HurufO") if f.endswith('.png')])
HurufP = len([f for f in os.listdir("HurufP") if f.endswith('.png')])
HurufQ = len([f for f in os.listdir("HurufQ") if f.endswith('.png')])
HurufR = len([f for f in os.listdir("HurufR") if f.endswith('.png')])
HurufS = len([f for f in os.listdir("HurufS") if f.endswith('.png')])
HurufT = len([f for f in os.listdir("HurufT") if f.endswith('.png')])
HurufU = len([f for f in os.listdir("HurufU") if f.endswith('.png')])
HurufV = len([f for f in os.listdir("HurufV") if f.endswith('.png')])
HurufW = len([f for f in os.listdir("HurufW") if f.endswith('.png')])
HurufX = len([f for f in os.listdir("HurufX") if f.endswith('.png')])
HurufY = len([f for f in os.listdir("HurufY") if f.endswith('.png')])
HurufZ = len([f for f in os.listdir("HurufZ") if f.endswith('.png')])
